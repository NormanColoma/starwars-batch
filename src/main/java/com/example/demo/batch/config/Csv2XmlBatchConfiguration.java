...
import com.example.demo.batch.listener.PeopleStepListener;
import com.example.demo.batch.processor.PeopleProcessor;
import com.example.demo.batch.repository.PeopleRepository;
...
public class Csv2XmlBatchConfiguration {
    ...
    @Bean
    public ItemWriter<People> peopleItemWriter(PeopleRepository repository) {
